        ...
        <DialogContent className="sm:max-w-md p-0 overflow-hidden">
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 px-4 border-2 border-input rounded-lg focus:border-primary outline-none transition-colors"
                  placeholder="Enter your email or phone"
                />
              </div>

              <Button variant="cta" size="xl" className="w-full rounded-full">
                Continue
              </Button>
            ...
            <div className="flex justify-center gap-4">
              <button className="w-12 h-12 rounded-full border-2 border-input hover:border-primary flex items-center justify-center transition-colors">
