...
import { Search, User, Heart, ShoppingCart, ChevronDown, Menu, Sparkles } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center gap-4 lg:gap-6">
            ...
            <nav className="hidden lg:flex items-center gap-1 relative">
              ...
              <Link 
                to="/clearance"
                className="px-3 py-2 text-sm font-semibold text-destructive hover:bg-destructive/10 rounded-lg transition-colors flex items-center gap-1"
              >
                Clearance
              </Link>
              <button 
            ...
            <div className="flex-1 max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="w-full h-10 pl-4 pr-12 rounded-full border-2 border-border bg-muted focus:border-primary focus:bg-card outline-none transition-all text-sm"
                />
